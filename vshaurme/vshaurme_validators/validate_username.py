...
def is_username_valid(self, field):
    username = field.data
    ...
    try:
        ...
        return
    if ((username in english_black_list) 
        or (username in russian_black_list) 
        or (username in transliterate_to_english(russian_black_list))):
